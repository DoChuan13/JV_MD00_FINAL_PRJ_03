...
public final class ColorConfig {
     ...
     * Italic text style
     */
    private static final String ITALIC = "\033[3m";  // Bold
    /**
     ...
     */
    private static final String BLACK_ITALIC = "\033[3;30m";  // BLACK
    // Italics
    private static final String RED_ITALIC = "\033[3;31m";    // RED
    private static final String GREEN_ITALIC = "\033[3;32m";  // GREEN
    private static final String YELLOW_ITALIC = "\033[3;33m"; // YELLOW
    private static final String BLUE_ITALIC = "\033[3;34m";   // BLUE
    private static final String PURPLE_ITALIC = "\033[3;35m"; // PURPLE
    private static final String CYAN_ITALIC = "\033[3;36m";   // CYAN
    private static final String WHITE_ITALIC = "\033[3;37m";  // WHITE
    /**
    ...
    public static final String ACTIVE_COLOR = CYAN_BACKGROUND;
    ...
    public static final String BACK_COLOR = YELLOW_BRIGHT;
    ...
    public static final String BORDER_COLOR = WHITE_BRIGHT;
    public static final String INACTIVE_COLOR = WHITE_BRIGHT;
    // Bold High Intensity
    /**
