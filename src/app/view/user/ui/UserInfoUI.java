...
public final class UserInfoUI {
    public static void showMenuUpdateUserInfo(int option, User user, String password) {
        ...
        System.out.printf(ColorConfig.BORDER_COLOR + "|" + (option == 1 ? ColorConfig.ACTIVE_COLOR : ColorConfig.INACTIVE_COLOR) + "  " + (option != -1 ? "1" : "*") + ". " + MenuConst.WIDTH_2_COL + ColorConfig.BORDER_COLOR + "|\n" + ColorConfig.RESET, "UserName: ", user.getUserName());
        System.out.printf(ColorConfig.BORDER_COLOR + "|" + (option == 2 ? ColorConfig.ACTIVE_COLOR : ColorConfig.INACTIVE_COLOR) + "  " + (option != -1 ? "2" : "*") + ". " + MenuConst.WIDTH_2_COL + ColorConfig.BORDER_COLOR + "|\n" + ColorConfig.RESET, "Name: ", user.getName());
        System.out.printf(ColorConfig.BORDER_COLOR + "|" + (option == 3 ? ColorConfig.ACTIVE_COLOR : ColorConfig.INACTIVE_COLOR) + "  " + (option != -1 ? "3" : "*") + ". " + MenuConst.WIDTH_2_COL + ColorConfig.RESET + ColorConfig.BORDER_COLOR + "|\n" + ColorConfig.RESET, "Sex: ", (user.isGender() == null ? "Unknown" : user.isGender() ? "Male" : "Female"));
        System.out.printf(ColorConfig.BORDER_COLOR + "|" + (option == 4 ? ColorConfig.ACTIVE_COLOR : ColorConfig.INACTIVE_COLOR) + "  " + (option != -1 ? "4" : "*") + ". " + MenuConst.WIDTH_2_COL + ColorConfig.BORDER_COLOR + "|\n" + ColorConfig.RESET, "Email: ", user.getEmail());
        if (option != -1) {
